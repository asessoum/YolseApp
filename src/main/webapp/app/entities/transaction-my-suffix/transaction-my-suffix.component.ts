...
export class TransactionMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.transactionService
            ...
            .subscribe(
                (res: HttpResponse<ITransactionMySuffix[]>) => this.paginateTransactions(res.body, res.headers),
    ...
    protected paginateTransactions(data: ITransactionMySuffix[], headers: HttpHeaders) {
