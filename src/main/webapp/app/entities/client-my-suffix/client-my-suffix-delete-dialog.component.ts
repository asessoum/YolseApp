...
export class ClientMySuffixDeleteDialogComponent {
    ...
    constructor(private clientService: ClientMySuffixService, public activeModal: NgbActiveModal, private eventManager: JhiEventManager) {}
...
export class ClientMySuffixDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ client }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ClientMySuffixDeleteDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
