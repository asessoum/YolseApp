...
/**
 * REST controller for managing {@link fr.yolse.app.domain.Pays}.
 */
@RestController
@RequestMapping("/api")
public class PaysResource {
    ...
    public ResponseEntity<PaysDTO> updatePays(@Valid @RequestBody PaysDTO paysDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paysDTO.getId().toString()))
            .body(result);
    }
