...
/**
 * REST controller for managing {@link fr.yolse.app.domain.UtiProfile}.
 */
@RestController
@RequestMapping("/api")
public class UtiProfileResource {
    ...
    public ResponseEntity<UtiProfileDTO> updateUtiProfile(@Valid @RequestBody UtiProfileDTO utiProfileDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, utiProfileDTO.getId().toString()))
            .body(result);
    }
