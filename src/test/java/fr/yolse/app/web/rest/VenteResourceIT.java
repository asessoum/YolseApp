...
import fr.yolse.app.repository.VenteRepository;
import fr.yolse.app.service.VenteService;
import fr.yolse.app.service.dto.VenteDTO;
import fr.yolse.app.service.mapper.VenteMapper;
...
public class VenteResourceIT {
    ...
    public void createVente() throws Exception {
        ...
        assertThat(testVente.getVenteID()).isEqualTo(DEFAULT_VENTE_ID);
        assertThat(testVente.getLocalID()).isEqualTo(DEFAULT_LOCAL_ID);
    ...
    public void updateVente() throws Exception {
        ...
        Vente testVente = venteList.get(venteList.size() - 1);
        assertThat(testVente.getVenteID()).isEqualTo(UPDATED_VENTE_ID);
        assertThat(testVente.getLocalID()).isEqualTo(UPDATED_LOCAL_ID);
