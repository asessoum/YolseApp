...
import fr.yolse.app.repository.CommuneRepository;
import fr.yolse.app.service.CommuneService;
import fr.yolse.app.service.dto.CommuneDTO;
import fr.yolse.app.service.mapper.CommuneMapper;
...
public class CommuneResourceIT {
    ...
    private static final Integer DEFAULT_COMMUNE_ID = 1;
    private static final Integer UPDATED_COMMUNE_ID = 2;
    ...
    public void createCommune() throws Exception {
        ...
        assertThat(testCommune.getCommuneID()).isEqualTo(DEFAULT_COMMUNE_ID);
    ...
    @Test
    @Transactional
    public void checkCommuneIDIsRequired() throws Exception {
        int databaseSizeBeforeTest = communeRepository.findAll().size();
        // set the field null
        commune.setCommuneID(null);
    ...
    public void getAllCommunes() throws Exception {
        ...
        restCommuneMockMvc.perform(get("/api/communes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].communeID").value(hasItem(DEFAULT_COMMUNE_ID)))
    ...
    public void getCommune() throws Exception {
        ...
        restCommuneMockMvc.perform(get("/api/communes/{id}", commune.getId()))
            ...
            .andExpect(jsonPath("$.communeID").value(DEFAULT_COMMUNE_ID))
    ...
    public void updateCommune() throws Exception {
        ...
        Commune testCommune = communeList.get(communeList.size() - 1);
        assertThat(testCommune.getCommuneID()).isEqualTo(UPDATED_COMMUNE_ID);
