...
import fr.yolse.app.domain.Categorie;
import fr.yolse.app.repository.CategorieRepository;
import fr.yolse.app.service.CategorieService;
import fr.yolse.app.service.dto.CategorieDTO;
import fr.yolse.app.service.mapper.CategorieMapper;
...
public class CategorieResourceIT {
    ...
    private static final Integer DEFAULT_CATEGORIE_ID = 1;
    private static final Integer UPDATED_CATEGORIE_ID = 2;
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie()
            .categorieID(DEFAULT_CATEGORIE_ID)
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie()
            .categorieID(UPDATED_CATEGORIE_ID)
    ...
    public void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getCategorieID()).isEqualTo(DEFAULT_CATEGORIE_ID);
        assertThat(testCategorie.getLocalID()).isEqualTo(DEFAULT_LOCAL_ID);
    ...
    @Test
    @Transactional
    public void checkCategorieIDIsRequired() throws Exception {
        int databaseSizeBeforeTest = categorieRepository.findAll().size();
        // set the field null
        categorie.setCategorieID(null);
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].categorieID").value(hasItem(DEFAULT_CATEGORIE_ID)))
    ...
    public void getCategorie() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories/{id}", categorie.getId()))
            ...
            .andExpect(jsonPath("$.categorieID").value(DEFAULT_CATEGORIE_ID))
    ...
    public void updateCategorie() throws Exception {
        ...
        Categorie testCategorie = categorieList.get(categorieList.size() - 1);
        assertThat(testCategorie.getCategorieID()).isEqualTo(UPDATED_CATEGORIE_ID);
        assertThat(testCategorie.getLocalID()).isEqualTo(UPDATED_LOCAL_ID);
