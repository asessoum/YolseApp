...
import fr.yolse.app.repository.UtiProfileRepository;
import fr.yolse.app.service.UtiProfileService;
import fr.yolse.app.service.dto.UtiProfileDTO;
import fr.yolse.app.service.mapper.UtiProfileMapper;
...
/**
 * Test class for the UtiProfileResource REST controller.
 *
 * @see UtiProfileResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = YolseApp.class)
public class UtiProfileResourceIntTest {
    ...
    public void createUtiProfile() throws Exception {
        ...
        assertThat(testUtiProfile.getUtiProID()).isEqualTo(DEFAULT_UTI_PRO_ID);
    ...
    public void updateUtiProfile() throws Exception {
        ...
        UtiProfile testUtiProfile = utiProfileList.get(utiProfileList.size() - 1);
        assertThat(testUtiProfile.getUtiProID()).isEqualTo(UPDATED_UTI_PRO_ID);
