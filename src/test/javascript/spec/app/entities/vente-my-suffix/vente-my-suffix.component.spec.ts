...
import { VenteMySuffixComponent } from 'app/entities/vente-my-suffix/vente-my-suffix.component';
...
describe('Component Tests', () => {
    describe('VenteMySuffix Management Component', () => {
        let comp: VenteMySuffixComponent;
        let fixture: ComponentFixture<VenteMySuffixComponent>;
        let service: VenteMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [YolseAppTestModule],
                declarations: [VenteMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(VenteMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(VenteMySuffixComponent);
