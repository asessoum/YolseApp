    ...
    describe('ClientMySuffix Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a ClientMySuffix', () => {
                service.create(new ClientMySuffix(null)).subscribe(received => {
            ...
            it('should update a ClientMySuffix', () => {
                service.update(new ClientMySuffix(123)).subscribe(received => {
            ...
            it('should return a ClientMySuffix', () => {
            ...
            it('should return a list of ClientMySuffix', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ClientMySuffix(123)]);
            });
